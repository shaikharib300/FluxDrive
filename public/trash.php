<?php
require_once __DIR__.'/../includes/functions.php'; $u=require_auth(); $title='Trash — FluxDrive';
$st=db()->prepare('SELECT f.* FROM files f WHERE f.user_id=? AND f.is_deleted=1 ORDER BY f.deleted_at DESC'); $st->execute([$u['id']]); $rows=$st->fetchAll();
include __DIR__.'/../includes/header.php'; include __DIR__.'/../includes/sidebar.php'; ?>
<div class="app-shell"><div class="main"><?php include __DIR__.'/../includes/navbar.php';?><section class="page-wrap"><div class="page-heading"><div><span class="eyebrow">TRASH</span><h1>Trash</h1><p>Manage your trash items.</p></div></div><div class="panel"><div class="table-responsive"><table class="table align-middle file-table"><thead><tr><th>Name</th><th>Type</th><th>Size</th><th>Modified</th><th></th></tr></thead><tbody>
